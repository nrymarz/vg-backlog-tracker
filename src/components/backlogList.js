...
export default function BacklogList({games, variant, handleSelect}){
                    ...
                    <h5>
                        ...
                        <Dropdown as="span">
                            ...
                            <Dropdown.Menu>
                                ...
                                <Dropdown.Item eventKey='REMOVE' onSelect={event => handleSelect(event,game)}>Remove Game</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
                    </h5>
                </ListGroup.Item>
